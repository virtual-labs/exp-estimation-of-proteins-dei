...
- A is the absorbance,</li>
- &epsilon; is the molar extinction coefficient,</li>
- c is the concentration of the analyte,</li>
- l is the path length in cm.</li>
...
## Bicinchoninic Acid (BCA) (Range: 0.2-50 &mu;g)
The BCA reaction forms an intense purple complex with cuprous ions (Cu<sup>+</sup>) resulting from the reaction of protein and alkaline Cu2+. The residues that contribute to the reduction of Cu<sup>2+</sup> include the cysteine, cystine, tryptophan, tyrosine, and the peptide bonds (Smith et al., 1985).
